...
export const tracks = [
  ['01', 'Web', 'Map the attack surface.'],
  ['02', 'Crypto', 'Read what the cipher hides.'],
  ['03', 'Forensics', 'Reconstruct the evidence.'],
  ['04', 'Reverse', 'Trace the logic underneath.'],
  ['05', 'Pwn', 'Take control of the machine.'],
  ['06', 'OSINT', 'Follow the open signal.'],
]
